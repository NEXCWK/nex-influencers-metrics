...
export function IconSignal({ size }) {
  return (
    <Svg size={size}>
...
export function IconMessageCircle({ size }) {
  return (
    <Svg size={size}>
...
export function IconTicket({ size }) {
  return (
    <Svg size={size}>
...
export function IconImages({ size }) {
  return (
    <Svg size={size}>
...
export function IconBarChart({ size }) {
  return (
    <Svg size={size}>
